    ...
    <main className="w-full bg-[var(--background)] text-[var(--foreground)]">
        ...
        >
          ...
          <div className="flex justify-center md:justify-start gap-4 pt-4">
            <motion.a whileHover={{ scale: 1.2 }} href="#" aria-label="Twitter">
              <Twitter className="w-6 h-6 text-[var(--primary)]" />
            </motion.a>
            <motion.a
      ...
      >
        {[
          {
            icon: (
              <Globe2 className="w-10 h-10 mx-auto mb-4 text-[var(--primary)]" />
            ),
          ...
          {
            icon: (
              <Users2 className="w-10 h-10 mx-auto mb-4 text-[var(--primary)]" />
            ),
